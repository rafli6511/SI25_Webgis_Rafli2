...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="<?= base_url('Admin') ?>" class="brand-link">
      <img src="<?= base_url() ?>/logo/gis.png" class="brand-image img-circle elevation-3" alt="GIS Logo">
      <span class="brand-text font-weight-light">GIS Pendataan Rumah</span>
    </a>
    <div class="sidebar">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?= date('Y') ?> <a href="<?= base_url('Admin') ?>">WEB GIS DATA RUMAH</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
